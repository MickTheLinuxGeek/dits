...
exports.applySwaggerMiddleware = void 0;
...
const swaggerDefinition = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'Developer Issue Tracking System (DITS) REST API documentation. ' +
    ...
    servers: [
        {
            url: env_1.config.app.url,
            description: `${env_1.config.app.env} server`,
        },
    ],
    components: {
        securitySchemes: {
...
exports.applySwaggerMiddleware = applySwaggerMiddleware;
/**
